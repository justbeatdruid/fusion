...
import (
	...
	"github.com/chinamobile/nlpt/crds/restriction/controllers"
...
func main() {
	...
	if err = (&controllers.RestrictionReconciler{
		Client:   mgr.GetClient(),
		Log:      ctrl.Log.WithName("controllers").WithName("Restriction"),
		Scheme:   mgr.GetScheme(),
		Operator: operator,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "Restriction")
		os.Exit(1)
	}
