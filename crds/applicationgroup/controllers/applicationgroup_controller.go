...
import (
	...
	nlptv1 "github.com/chinamobile/nlpt/crds/applicationgroup/api/v1"
)
...
// +kubebuilder:rbac:groups=nlpt.cmcc.com,resources=applicationgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nlpt.cmcc.com,resources=applicationgroups/status,verbs=get;update;patch
