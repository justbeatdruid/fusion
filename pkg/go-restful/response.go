...
type Response struct {
	...
	entityValues  []interface{}
}

// NewResponse creates a new response based on a http ResponseWriter.
func NewResponse(httpWriter http.ResponseWriter) *Response {
	hijacker, _ := httpWriter.(http.Hijacker)
	return &Response{ResponseWriter: httpWriter, routeProduces: []string{}, statusCode: http.StatusOK, prettyPrint: PrettyPrintResponses, hijacker: hijacker, entityValues: []interface{}{}}
}
...
func (r *Response) WriteHeaderAndEntity(status int, value interface{}) error {
	r.entityValues = append(r.entityValues, value)
...
func (r Response) GetEntities() []interface{} {
